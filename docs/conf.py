...
g = {}
with open(os.path.join('..', 'reana_workflow_commons', 'version.py'), 'rt') as fp:
    exec(fp.read(), g)
...
html_theme_options = {
    'logo': 'logo-reana.png',
    'description': """<p>REANA-Workflow-Commons is a component of the <a
                      href="http://www.reana.io">REANA</a> reusable and
                      reproducible research data analysis
                      platform.</p><p>REANA-Workflow-Commons provides common
                      utilities and schemas shared by the REANA runtime
                      components.</p>""",
    'github_user': 'reanahub',
    'github_repo': 'reana-workflow-commons',
    'github_button': False,
    'github_banner': True,
